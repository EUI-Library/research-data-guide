# The FAIR Principles {.unnumbered}

::: {.callout-warning icon=false}
## Learning outcomes

  - How to apply the **F**indable, **A**ccessible, **I**nteroperable and **R**eusable (**FAIR**) guiding principles when working with data

:::

The FAIR guiding principles for scientific data management and stewardship [@Wilkinson2016fair] were developed as guidelines to improve the **F**indability, **A**ccessibility, **I**nteroperability and **R**eusability of digital assets. All of which support research reproducibility. The FAIR principles play an important role in making your data available to others for reuse but also make you aware of the importance of data in the scholarly communication landscape.

It is much easier to make data FAIR if you plan to do this from the beginning of your research project. You can plan for this in your Data Management Plan (DMP) (see chapter @sec-dmp for details).
...
This chapter provides an abstract and broad view of what the FAIR principles are. How to put the FAIR principles into practice is discussed in other chapters ( {ref}`Data Organisation in Spreadsheets<rr-rdm-fair>`, {ref}`Documentation and Metadata<rr-rdm-metadata>` and {ref}`Sharing and Archiving Data<rr-rdm-sharing>`). You can also use the [Wellcome Getting Started Guide](https://f1000researchdata.s3.amazonaws.com/resources/FAIR_Open_GettingStarted.pdf) or the [How To FAIR](https://howtofair.dk/) website to find out more about the FAIR principles and how to get started.
...
## Credits
Content in this chapter has been adapted and reused from the excellent work:
