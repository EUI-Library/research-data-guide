...
EUI **Principal Investigators** and **Project Managers** preparing a data management plan for funded projects should carefully follow the instructions provided by the relevant science programme office (eg. **Horizon Europe**, **European Research Council** etc.). Where a DMP template is provided, this must be used, for example: 
